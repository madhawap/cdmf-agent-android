...
//import org.wso2.emm.system.service.utils.Version;
//
...
//    private static final String BUILD_VERSION_RELEASE_PROPERTY = "ro.build.version.release";
//    private static final String BUILD_DEVICE_PROPERTY = "ro.product.device";
...
//        serverConfig = new OTAServerConfig("swordfish", context);  // TODO change back from "swordfish" to Build.PRODUCT
...
//        }
//
//        String remoteVersionString = parser.getProp(BUILD_VERSION_RELEASE_PROPERTY);
//        String localVersionString = SystemProperties.get(BUILD_VERSION_RELEASE_PROPERTY);
//
//        Log.i(TAG, "Remote release version: " + remoteVersionString + "; local release version: " + localVersionString);
//        Log.i(TAG, "Local display ID: " + Build.VERSION.INCREMENTAL + " Server display ID:" + parser.getNumRelease());
//
//
//        Matcher remoteVersionMatcher = versionPattern.matcher(remoteVersionString);
//        Matcher localVersionMatcher = versionPattern.matcher(localVersionString);
//
//        boolean upgrade = false;
//
//        if (remoteVersionMatcher.matches() && localVersionMatcher.matches()) { // both versions of pattern a.b.c
...
//                Log.i(TAG, "Remote version is greater; triggering OTA upgrade");
//                upgrade = true;
//            } else {
//                Log.w(TAG, "Remote version is lower; rejecting OTA upgrade");
//            }
//
//
//        } else if (remoteVersionMatcher.matches()) {  // if remote image has format a.b.c, but local doesn't
//            Log.i(TAG, "Older version detected of local image; triggering OTA upgrade");
//            upgrade = true;
//
//        } else if (localVersionMatcher.matches()) { // if local image has format a.b.c, but remote doesn't
//            Log.i(TAG, "Older version detected of remote image; rejecting OTA upgrade");
//
//        } else { // if neither local image nor remote use a.b.c format, compare UTC timestamp
//            Log.i(TAG, "Older version detected of local and remote image");
//
...
//            }
//
//            Log.i(TAG, "local UTC: " + buildTime + "; remote UTC: " + remoteBuildUTC);
//
//            upgrade = remoteBuildUTC > buildTime;
//        }
//
//
//        return upgrade;
...
//
//
//    public boolean compareLocalDeviceToServer(BuildPropParser parser) {
//        if (parser == null) {
//            Log.e(TAG, "compareLocalDeviceToServer Without fetch remote prop list.");
//            return false;
//        }
//
//        String remoteDeviceString = parser.getProp(BUILD_DEVICE_PROPERTY);
//        String localDeviceString = SystemProperties.get(BUILD_DEVICE_PROPERTY);
//
//        Log.i(TAG, "Remote release device: " + remoteDeviceString + "; local release device: " + localDeviceString);
//
//        if (remoteDeviceString != null && remoteDeviceString.equals(localDeviceString)){
//            Log.i(TAG, "Device type matches... proceeding with download");
//            return true;
//        } else {
//            Log.e(TAG, "Device type doesn't match; not installing update");
//            return false;
//        }
//    }
//
...
//            Log.i(TAG, "Download Progress - " + progress + "% - Downloaded:" + downloaded + "/" + total);
//            if (progress == 100) {
//                Preference.putString(context, context.getResources().getString(R.string.firmware_download_progress),
...
//            if (targetFile.exists()) {
//                targetFile.delete();
//                Log.i(TAG, "Previous update in /cache/ota/update.zip has been deleted.");
//            }
//
...
//                boolean isAvailabledownloadReference = Preference.getBoolean(context, context.getResources().getString(R.string.download_Manager_reference_id_available));
//
//                // check if reference is really available
//                if (isAvailabledownloadReference) {
//                    DownloadManager.Query testQuery = new DownloadManager.Query();
//                    testQuery.setFilterById(Preference.getLong(context, context.getResources().getString(R.string.download_Manager_reference_id)));
//                    Cursor testCursor = downloadManager.query(testQuery);
//                    if (testCursor.getCount() == 0){
//                        isAvailabledownloadReference = false;
//                        Preference.putBoolean(context, context.getResources().getString(R.string.download_Manager_reference_id_available), false);
//                        Log.e(TAG, "Reference is not available; removing it from DownloadManager");
//                    }
//                    testCursor.close();
//                }
//
...
//
//                if(!isAvailabledownloadReference) {
//                    sendNotification(OTA_NOTIFICATION_ID_START, context.getString(R.string.txt_ota_start_download_text), context.getString(R.string.txt_ota_start_download_title), false);
...
//                                    sendNotification(OTA_NOTIFICATION_ID_START, context.getString(R.string.txt_ota_paused_text), context.getString(R.string.txt_ota_start_download_title), false);
//                                }
//                                isPaused = true;
//                            }
//
...
//                                                sendNotification(OTA_NOTIFICATION_ID_PROGRESS, context.getString(R.string.txt_ota_progress_download_text), context.getString(R.string.txt_ota_start_download_text), true);
//                                            }
//                                            Log.i(TAG, "downloaded progress: " + downloadProgress + "%");
//                                        }
...
//        try {
//            wakeLock.acquire();
//            Log.i(TAG, "Verifying upgrade package");
...
//                    Log.i(TAG, "Start download: " + url.toString() + " to buffer");
//
...
//                    }
//
//                    Log.i(TAG, "Download finished: " + (Integer.toString(totalBufRead)) + " bytes downloaded");
//
...
//                File file = new File(downloadDirectoryPath, "update.zip");
//                if (file.exists()) {
//                    Preference.putString(context, context.getResources().getString(R.string.upgrade_download_status),
//                            context.getResources().getString(R.string.status_success));
//                }
